      ...
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        <Link to="/">
          <div>
            ...
            <p className="text-[10px] text-slate-200 tracking-wider">
              Shorten • Track • Share
            </p>
          </div>
        </Link>
          ...
          >
            ...
            {!token && (
              <>
                <Link to="/login">
                  <li className="text-gray-200 font-medium cursor-pointer">
                    Login
                  </li>
                </Link>

                <Link to="/register">
                  <li className="bg-rose-700 text-white cursor-pointer w-28 text-center font-semibold px-2 py-2 rounded-md hover:text-slate-300 transition-all duration-150">
                    Get Started
                  </li>
                </Link>
              </>
